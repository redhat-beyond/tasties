    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('minutes_to_make', models.IntegerField(validators=[django.core.validators.MinValueValidator(1)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                                to=settings.AUTH_USER_MODEL)),
                ('recipe_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tasties_app.recipe')),
            ],
        ),
        migrations.CreateModel(
            name='Ingredient',
            fields=[
                ...
                ('measurement_unit', models.CharField(choices=[('WHOLE', 'Whole'), ('FLOZ', 'Fluid Ounce'),
                                                               ('TSP', 'Teaspoon'), ('OZ', 'Ounce'), ('CUP', 'Cup'),
                                                               ('GRAM', 'Gram'), ('ML', 'Milliliter')],
                                                      default='WHOLE', max_length=8)),
